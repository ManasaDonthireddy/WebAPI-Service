...
namespace Capsule_TaskManager_Test.Controllers
{
    public class TaskManager_NunitController : Controller
    {
        ...
        public void InsertTaskDetails()
        {
            ...
            objGET_TASK_DETAILS_Result.Task_ID = "5";
            objGET_TASK_DETAILS_Result.Parent_ID = "1";
            objGET_TASK_DETAILS_Result.Task = "Deployment";
        ...
        public void UpdateEndTask()
        {
            ...
            objGET_TASK_DETAILS_Result.Task_ID = "2";
            objGET_TASK_DETAILS_Result.End_Date = DateTime.Now;
